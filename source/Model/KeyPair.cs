...
namespace Casascius.Bitcoin {
    ...
    public class KeyPair : PublicKey {
        ...
        /// </summary>
        public KeyPair(BigInteger bi, bool compressed = false, byte addressType = 55) {
        ...
        /// </summary>
        public KeyPair(byte[] bytes, bool compressed=false, byte addressType=55) {
            if (bytes.Length == 32) {
        ...
        /// </summary>
        public KeyPair(string key, bool compressed=false, byte addressType=55) {
            this._addressType = addressType;
